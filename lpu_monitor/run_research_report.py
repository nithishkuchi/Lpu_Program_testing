...
Records: Research information for ALL programmes.
"""
...
OUT_XLSX = "records_research.xlsx"
...
async def main():
    ...
    print("=" * 70)
    print(
        f"Total research records : {len(df)}"
    )
    print(
